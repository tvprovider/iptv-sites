// Canonical host + scheme enforcement: www.iptvpoland.co and any plain-HTTP
// request 301-redirect to https://iptvpoland.co, avoiding duplicate content
// across the www/non-www and http/https variants of the site.
export async function onRequest(context) {
  const url = new URL(context.request.url);
  let changed = false;

  if (url.hostname === 'www.iptvpoland.co') {
    url.hostname = 'iptvpoland.co';
    changed = true;
  }
