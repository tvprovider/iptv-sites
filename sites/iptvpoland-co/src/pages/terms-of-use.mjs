...
export default {
  slug: 'terms-of-use',
  title: 'Terms of Use | IPTV Poland',
  description: `The terms governing use of the ${site.brand} subscription service, including accounts, acceptable use, billing, and liability.`,
...
${section({
  ...
  <div class="prose">
    ...
    <p>Using ${site.domain}, or subscribing to the ${site.brand} service, means you accept these Terms of Use. If any part of them doesn't work for you, the service isn't a fit.</p>

    <h2>What the service is</h2>
    <p>${site.brand} is an IPTV subscription built around Polish television — Ekstraklasa, Polish news, regional stations, and entertainment — alongside a full English-language and international catalog, delivered over the internet through compatible third-party player apps, with resolution up to 4K where your plan, device, and the original source all allow it.</p>

    <h2>Accounts and activation</h2>
    <p>Subscribing or starting the trial gets you activation details by email. Keeping those details confidential, and anything that happens under them, is your responsibility.</p>

    <h2>Acceptable use</h2>
    <p>The service is for personal, non-commercial viewing. Specifically, you agree not to:</p>
    <ul>
      ...
      <li>Attempt to circumvent, disrupt, or reverse-engineer the underlying infrastructure</li>
    </ul>

    <h2>Billing and plans</h2>
    <p>Prices for every plan are posted on the <a href="/pricing/">Pricing page</a> as of the time you order. Nothing renews automatically unless a recurring option was explicitly chosen — starting a new term after the current one ends is a decision you make each time.</p>
    ...
    <p>These terms are updated periodically. The "last updated" date above marks the most recent revision, and continuing to use the service after a change means the updated version applies to you.</p>
