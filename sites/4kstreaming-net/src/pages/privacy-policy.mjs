...
export default {
  slug: 'privacy-policy',
  title: 'Privacy Policy | 4K Streaming',
  description: 'Read the 4K Streaming privacy policy to understand what information we collect, why we collect it, and how it is used and protected.',
  noindex: false,
