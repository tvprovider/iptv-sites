...
export default {
  slug: 'terms-of-use',
  title: 'Terms of Use | 4K Streaming',
  description: 'Read the terms governing your use of the 4K Streaming IPTV subscription service, including accounts, acceptable use, billing, and liability.',
