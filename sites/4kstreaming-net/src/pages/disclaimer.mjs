...
export default {
  slug: 'disclaimer',
  title: 'Disclaimer | 4K Streaming',
  description: 'Important disclaimers regarding the use of the 4K Streaming IPTV service, content responsibility, and third-party affiliations.',
