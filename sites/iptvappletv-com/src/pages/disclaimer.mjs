...
${section({
  ...
  <div class="prose">
    ...
    <h2>Independence from Apple Inc.</h2>
    <p>${site.brand} is an independent, third-party streaming subscription service. It is <strong>not affiliated with, endorsed by, sponsored by, or officially connected to Apple Inc. in any way.</strong> "Apple," "Apple TV," "App Store," "tvOS," "iPhone," and "iPad" are trademarks of Apple Inc., registered in the US and other countries. We use these names only to describe which hardware and software our service is compatible with, and to help visitors find setup information for that hardware — never to suggest an official partnership, sponsorship, or endorsement that does not exist. Apple Inc. has not reviewed, approved, or endorsed the content of this site.</p>
    ...
    <p>Beyond Apple specifically, ${site.brand} is not affiliated with, endorsed by, or sponsored by any television network, broadcaster, streaming platform, device manufacturer, or player app developer mentioned or implied on this site. Any device or app names referenced (such as Smart TV, Android TV, Fire TV, or Windows) are used only to describe compatibility and remain the property of their respective owners.</p>
