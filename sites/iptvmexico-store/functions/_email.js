...
const BRAND_RED = '#0891b2';
const TEXT_DARK = '#0b2a33';
const TEXT_SOFT = '#4a6a72';
const BORDER = '#cffafe';
const BG = '#ecfeff';
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px; background:#ffffff; border-radius:12px; overflow:hidden; border:1px solid ${BORDER};">
        <tr>
          <td style="background:${BRAND_RED}; padding:22px 32px;">
            <span style="color:#ffffff; font-size:19px; font-weight:600; letter-spacing:-0.01em; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;">IPTV Mexico</span>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="padding:24px 32px 32px; border-top:1px solid ${BORDER};">
            <p style="margin:0; font-size:12.5px; color:${TEXT_SOFT}; line-height:1.6;">
              IPTV Mexico &middot; <a href="https://iptvmexico.store" style="color:${TEXT_SOFT};">iptvmexico.store</a><br>
