...
export default {
  slug: 'refund-policy',
  title: 'Refund Policy | IPTV Mexico',
...
${section({
  ...
  <div class="prose">
    ...
    <h2>24-hour trial</h2>
    <p>The ${trial.label} costs $${trial.price.toFixed(2)} and exists specifically as a low-cost way to check the Mexican and international lineup before committing further. Given the nominal fee and short window, trial charges are generally non-refundable once activation details go out. If the trial genuinely couldn't be accessed due to an error on our end, contact support and it gets made right.</p>
    ...
    <p>Requests based on general dissatisfaction with streaming quality are reviewed case by case. Since quality depends partly on your own connection and device, we expect you to work with support first to rule out a setup issue before a refund on this basis.</p>
