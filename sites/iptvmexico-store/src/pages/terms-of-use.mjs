...
export default {
  slug: 'terms-of-use',
  title: 'Terms of Use | IPTV Mexico',
...
${section({
  ...
  <div class="prose">
    ...
    <p>Using ${site.domain}, or subscribing to the ${site.brand} service, means you accept these Terms of Use. If any part of them doesn't sit right with you, the service isn't for you.</p>

    <h2>What the service actually is</h2>
    <p>${site.brand} is an IPTV subscription built around Mexican television — Liga MX, Selección Mexicana, novelas, and Mexican news and entertainment — alongside a full English-language and international catalog, delivered over the internet through compatible third-party player apps, with up to 4K resolution where your plan, device, and the original source all allow it.</p>
    ...
    <p>Prices for every plan sit on the <a href="/pricing/">Pricing page</a> as of the time you order. Nothing renews on its own unless a recurring option was explicitly chosen — starting a new term after the current one ends is a decision you make each time.</p>
