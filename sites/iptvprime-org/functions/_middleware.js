// Canonical host + scheme enforcement: www.iptvprime.org and any plain-HTTP
// request 301-redirect to https://iptvprime.org, avoiding duplicate content
// across the www/non-www and http/https variants of the site.
export async function onRequest(context) {
  const url = new URL(context.request.url);
  let changed = false;

  if (url.hostname === 'www.iptvprime.org') {
    url.hostname = 'iptvprime.org';
    changed = true;
  }
