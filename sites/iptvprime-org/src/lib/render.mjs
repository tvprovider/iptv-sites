...
function logoMark({ height = 32, onDark = false } = {}) {
  ...
  const textFill = onDark ? '#ffffff' : '#221e54';
  return `<svg width="${width}" height="${height}" viewBox="0 0 192 32" role="img" aria-label="IPTV Prime — premium IPTV subscription logo"><rect width="32" height="32" rx="7" fill="#1e1b4b"/><rect x="6" y="7" width="20" height="15" rx="3" fill="#3730a3"/><rect x="8.2" y="9.2" width="15.6" height="10" rx="1.8" fill="#1e1b4b"/><path d="M13.5 11 L13.5 17.4 L19 14.2 Z" fill="#ffffff"/><rect x="14" y="22" width="4" height="3" fill="#3730a3"/><rect x="10" y="25" width="12" height="2" rx="1" fill="#3730a3"/><text x="42" y="23" font-family="Inter, Arial, sans-serif" font-size="16" font-weight="600" fill="${textFill}">IPTV Prime</text></svg>`;
}
    ...
    <div class="container">
      <div class="footer-grid">
        <div>
          ...
          <p style="max-width:32ch;">The same premium catalog and support line, whichever plan you pick.</p>
        </div>
...
<svg viewBox="0 0 560 420" role="img" aria-label="${esc(label)}">
  ...
  <rect x="60" y="60" width="220" height="220" rx="12" fill="none" stroke="#c7d2fe" stroke-width="2"/>
  <rect x="110" y="110" width="220" height="220" rx="12" fill="#ffffff" stroke="#a5b4fc" stroke-width="2"/>
  <rect x="160" y="160" width="220" height="220" rx="12" fill="#e0e7ff" opacity="0.7"/>
  <circle cx="270" cy="270" r="46" fill="#3730a3"/>
  ${iconInner}
</svg>`;
}
