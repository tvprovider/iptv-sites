...
${section({
  ...
  <div class="prose">
    ...
    <p>${site.brand} is an IPTV subscription providing a premium-tier live channel and on-demand catalog, delivered over the internet through compatible third-party player apps, with resolution up to 4K where your plan, device, and the original source all allow it. Every plan length reaches the identical catalog.</p>
