...
export async function onRequestPost({ request, env }) {
  ...
  const resendRes = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: 'America IPTV <leads@americaiptv.store>',
      to: LEAD_DESTINATION,
      reply_to: email,
  ...
  const customerHtml = emailLayout({
    ...
    `,
    ctaLabel: 'Visit americaiptv.store',
    ctaHref: 'https://americaiptv.store',
  });
  ...
  await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      subject: "We've received your message — America IPTV",
      html: customerHtml,
