...
export default {
  slug: 'disclaimer',
  title: 'Disclaimer | America IPTV',
  description: 'Important disclaimers regarding the use of the America IPTV service, content responsibility, and third-party affiliations.',
