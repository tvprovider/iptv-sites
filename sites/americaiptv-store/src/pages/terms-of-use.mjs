...
export default {
  slug: 'terms-of-use',
  title: 'Terms of Use | America IPTV',
  description: 'Read the terms governing your use of the America IPTV subscription service, including accounts, acceptable use, billing, and liability.',
