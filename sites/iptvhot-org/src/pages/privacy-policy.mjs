...
export default {
  slug: 'privacy-policy',
  title: 'Privacy Policy | IPTV Hot',
  description: 'Read the IPTV Hot privacy policy to understand what information is collected, why it is collected, and how it is used and protected.',
  noindex: false,
