...
export default {
  slug: 'terms-of-use',
  title: 'Terms of Use | IPTV Hot',
  description: 'Read the terms governing your use of the IPTV Hot subscription service, including accounts, acceptable use, billing, and liability.',
