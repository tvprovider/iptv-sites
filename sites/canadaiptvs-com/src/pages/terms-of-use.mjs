...
export default {
  slug: 'terms-of-use',
  title: 'Terms of Use | Canada IPTV',
  description: 'Read the terms governing your use of the Canada IPTV subscription service, including accounts, acceptable use, billing, and liability.',
