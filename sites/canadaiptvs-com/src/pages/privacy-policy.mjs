...
export default {
  slug: 'privacy-policy',
  title: 'Privacy Policy | Canada IPTV',
  description: 'Read the Canada IPTV privacy policy to understand what information we collect, why we collect it, and how it is used and protected.',
  noindex: false,
