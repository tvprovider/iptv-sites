...
export async function onRequestPost({ request, env }) {
  ...
  const resendRes = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: 'IPTV Xtream Pro <leads@iptvextremepro.tv>',
      to: LEAD_DESTINATION,
      reply_to: email,
  ...
  const customerHtml = emailLayout({
    ...
    `,
    ctaLabel: 'Visit iptvextremepro.tv',
    ctaHref: 'https://iptvextremepro.tv',
  });
  ...
  await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      subject: "We've received your message — IPTV Xtream Pro",
      html: customerHtml,
