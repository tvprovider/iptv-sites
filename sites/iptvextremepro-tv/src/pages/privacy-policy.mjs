...
export default {
  slug: 'privacy-policy',
  title: 'Privacy Policy | IPTV Xtream Pro',
  description: 'Read the IPTV Xtream Pro privacy policy to understand what information we collect, why we collect it, and how it is used and protected.',
  noindex: false,
