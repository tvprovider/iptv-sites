...
function logoMark({ height = 32, onDark = false } = {}) {
  ...
  const textFill = onDark ? '#ffffff' : '#0c2818';
  return `<svg width="${width}" height="${height}" viewBox="0 0 180 32" role="img" aria-label="IPTV List — IPTV subscription logo"><rect width="32" height="32" rx="7" fill="#052e16"/><rect x="6" y="7" width="20" height="15" rx="3" fill="#16a34a"/><rect x="8.2" y="9.2" width="15.6" height="10" rx="1.8" fill="#052e16"/><path d="M13.5 11 L13.5 17.4 L19 14.2 Z" fill="#ffffff"/><rect x="14" y="22" width="4" height="3" fill="#16a34a"/><rect x="10" y="25" width="12" height="2" rx="1" fill="#16a34a"/><text x="42" y="23" font-family="Inter, Arial, sans-serif" font-size="16" font-weight="600" fill="${textFill}">IPTV List</text></svg>`;
}
    ...
    <div class="container">
      <div class="footer-grid">
        <div>
          ...
          <p style="max-width:32ch;">The real channel count, the real device list, and the real price per plan — posted before you ask.</p>
        </div>
...
<svg viewBox="0 0 560 420" role="img" aria-label="${esc(label)}">
  ...
  <rect x="60" y="60" width="220" height="220" rx="12" fill="none" stroke="#bbf7d0" stroke-width="2"/>
  <rect x="110" y="110" width="220" height="220" rx="12" fill="#ffffff" stroke="#86efac" stroke-width="2"/>
  <rect x="160" y="160" width="220" height="220" rx="12" fill="#dcfce7" opacity="0.7"/>
  <circle cx="270" cy="270" r="46" fill="#16a34a"/>
  ${iconInner}
</svg>`;
}
